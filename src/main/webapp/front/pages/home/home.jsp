            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="team agileits" id="team">
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in newsList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <div class="team-agile-img" @click="jumpCheck('../news/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img :src="item.newsPhoto?item.newsPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <div class="view-caption">
                                            <div class="w3ls-info">
                                                <h4>{{item.newsName}}</h4>
                                            </div>
                                            <b v-if="item.newsNewMoney" style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="team agileits" id="team">
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in shangpinList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <div class="team-agile-img" @click="jumpCheck('../shangpin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img :src="item.shangpinPhoto?item.shangpinPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <div class="view-caption">
                                            <div class="w3ls-info">
                                                <h4>{{item.shangpinName}}</h4>
                                            </div>
                                            <b v-if="item.shangpinNewMoney" style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
