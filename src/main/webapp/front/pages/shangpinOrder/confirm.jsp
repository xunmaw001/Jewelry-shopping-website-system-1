    ...
    <div class="page-order-comfirm">
        <div class="section-con">
            ...
            <div class="style-list pay">
                <ul class="clearfix">
                    <li :class="{'selected':shangpinOrderPaymentTypes==1}" @click="shangpinOrderPaymentTypes = 1">余额支付</li>
                    <li :class="{'selected':shangpinOrderPaymentTypes==2}" @click="shangpinOrderPaymentTypes = 2">积分支付</li>
                </ul>
            </div>
                ...
                <div class="orderC-table">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="orderC-tb">
                        ...
                        <tr v-for="(item,index) in dataList" v-bind:key="index">
                            ...
                            <td >
                                <span class="priceD">￥{{item.shangpinNewMoney*item.buyNumber}}</span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
