                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 jifenjiluNameDiv">
                                        <label>原因</label>
                                        <input style="width: 450px" id="jifenjiluName" name="jifenjiluName" class="form-control"
                                               placeholder="原因">
                                    </div>
                                    <div class="form-group col-md-6 jifenjiluNumberDiv">
                                        <label>积分数量</label>
                                        <input style="width: 450px" id="jifenjiluNumber" name="jifenjiluNumber" class="form-control"
                                               onchange="jifenjiluNumberChickValue(this)" placeholder="积分数量">
                                    </div>
                                    <div class="form-group col-md-6 jifenTypesDiv">
                                        <label>类型</label>
                                        <select style="width: 450px" id="jifenTypesSelect" name="jifenTypes" class="form-control">
                                        </select>
                                    </div>
